...
const cssPath = path.join(root, "phasevueicons.css");
...
if (!icons.length) {
  throw new Error("No icon classes found in phasevueicons.css");
}
...
<head>
    <meta charset="utf-8">
    <title>PhaseVueIcons Demo</title>
    <meta name="description" content="Icon Library for PhaseVue UI Library">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="demo-files/demo.css">
    <link rel="stylesheet" href="phasevueicons.css">
</head>
<body>
    <div class="bgc1 clearfix">
        <h1 class="mhmm mvm"><span class="fgc1">Font Name:</span> phasevueicons <small class="fgc1">(Glyphs:&nbsp;${icons.length})</small></h1>
    </div>
